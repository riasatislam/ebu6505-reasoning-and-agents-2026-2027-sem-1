...
\begin{center}\LARGE\bfseries Block 2 Tutorial -- Bayesian Networks, Exact Inference, Temporal Models, MDP Planning, DDNs, and POMDPs\end{center}

\begin{center}\large Block 2 Tutorial\end{center}

\begin{center}Semester 1, 2026--2027 --- Teaching Week 4\end{center}

\begin{tcolorbox}[colback=MidnightBlue!4,colframe=MidnightBlue,title={Session Overview},fonttitle=\bfseries,breakable]
\textbf{Session objective:} Consolidate the full Block 2 reasoning arc from uncertain belief to hidden-state planning using longer-form tutorial problems.
...
\textbf{Padlet board:} \url{https://padlet.com/qmul/b2-tutorial-6a1s440grh9uprtn}
\end{tcolorbox}
...
\item \textbf{Assessment focus:} connect Block 2 uncertainty tools to agent-system design choices
