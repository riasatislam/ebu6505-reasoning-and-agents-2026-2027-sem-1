...
\begin{center}\LARGE\bfseries Block 1 Tutorial -- Reinforcement Learning, Knowledge Graphs, MCP, Multi-Agent Systems, and Coding Agents\end{center}

\begin{center}\large Block 1 Tutorial\end{center}

\begin{center}Semester 1, 2026--2027 --- Teaching Week 3\end{center}

\begin{tcolorbox}[colback=MidnightBlue!4,colframe=MidnightBlue,title={Session Overview},fonttitle=\bfseries,breakable]
\textbf{Session objective:} Consolidate the whole of Block 1 with longer-form problems that strengthen exam-style reasoning and applied understanding.
...
\textbf{Padlet board:} \url{https://padlet.com/qmul/b1-tutorial-uqe9wb7pw5cpxo20}
\end{tcolorbox}
...
\item \textbf{Assessment focus:} combine Block 1 ideas into one system design
