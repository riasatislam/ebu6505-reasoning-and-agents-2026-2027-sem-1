...
% Metadata
% -------------------------
\title[EBU6505 B1 D5]{EBU6505 -- Reasoning and Agents\\Block 1, Day 5 -- Coding Agents and Knowledge-Grounded Reasoning}
...
\end{itemize}
\plainidea{Day 5 closes Block 1 by asking one practical question: how do these ideas help when an AI system must act, not just answer?}
\end{frame}
...
\begin{itemize}
  ...
  \item What can go wrong, and how we reduce risk before Block 2
\end{itemize}
...
\begin{itemize}
  ...
  \item connect Block 1 agent ideas to Block 2 uncertainty-aware decision models
\end{itemize}
\end{frame}
...
\begin{frame}{Transition to Block 2 Applications}
\keyquestion{What changes after Block 1?}
\begin{center}
\begin{tikzpicture}[>=Latex, every node/.style={font=\small}]
...
\end{tikzpicture}
\end{center}
\plainidea{Block 1 focused on structured knowledge and grounded agent behaviour. Block 2 asks what to do when the world is uncertain and the system must still choose an action.}
\end{frame}
