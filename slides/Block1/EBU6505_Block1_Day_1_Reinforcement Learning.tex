...
\usepackage{tikz}
\input{../shared/teaching_support.tex}
...
% Metadata
% -------------------------
\title[EBU6505 Block 1 Day 1]{EBU6505 -- Reasoning and Agents\\Block 1, Day 1 -- Reinforcement Learning}
\author{Dr Riasat Islam}
\institute{Queen Mary University of London}
\date[Teaching Week 3]{Semester 1, 2026--2027 \\ Teaching Week 3}
...
% Adapted from L00_ModuleIntro.ipynb (module context, teaching schedule,
% and learning objectives), tailored for Block 1, Semester 1 2026--2027.
\setslideref{AIMA4e Ch.10, Ch.17, and Ch.22; Poole3e Ch.12--13}
\begin{frame}{Welcome to Block 1}
\begin{block}{Neuro-Symbolic Reasoning and Agent Architectures}
Block 1 develops the foundations needed to build agents that can learn from
experience, represent knowledge, and reason with structured information.
\end{block}

\begin{columns}[T]
  \begin{column}{0.47\textwidth}
    \textbf{Teaching week 3}
    \begin{itemize}
      \item Five connected sessions
      \item Short explanations, worked examples, and Padlet activities
      \item From sequential decisions to knowledge-grounded agents
    \end{itemize}
  \end{column}
  \begin{column}{0.50\textwidth}
    \textbf{The five-day arc}
    \begin{enumerate}
      \item Reinforcement learning foundations
      \item Knowledge representation for agent memory
      \item Knowledge graph foundations
      \item Knowledge graphs in modern AI systems
      \item Coding agents and knowledge graph reasoning
    \end{enumerate}
  \end{column}
\end{columns}
...
\vspace{0.2cm}
\begin{center}
\textbf{Guiding question:} How can an agent combine learning, memory, and
reasoning to act responsibly?
\end{center}
\end{frame}

% 2
\setslideref{AIMA4e Ch.22 pp.789--822; Poole3e Ch.13 pp.583--608}
\begin{frame}{Background Concepts}
\begin{itemize}
...
\begin{frame}{What are we going to cover this week? -- Block 1}
\begin{itemize}
...
\begin{itemize}
  ...
  \item Block 2 later reuses the same decision foundations for planning under uncertainty.
\end{itemize}
\end{frame}
