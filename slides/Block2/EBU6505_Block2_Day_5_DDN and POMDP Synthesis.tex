...
% Metadata
% -------------------------
\title[EBU6505 B2 D5]{EBU6505 -- Reasoning and Agents\\Block 2, Day 5 -- Dynamic Decision Networks and POMDP Synthesis}
\author{Dr Riasat Islam}
\institute{Queen Mary University of London}
\date[Teaching Week 4]{Semester 1, 2026--2027 \\ Teaching Week 4}
...
\end{itemize}
\plainidea{Block 2 gives you one complete arc from uncertain evidence to informed action.}
\end{frame}
