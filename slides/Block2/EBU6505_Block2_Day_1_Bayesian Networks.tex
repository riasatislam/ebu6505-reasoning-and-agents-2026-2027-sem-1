...
% Metadata
% -------------------------
\title[EBU6505 B2 D1]{EBU6505 -- Reasoning and Agents\\Block 2, Day 1 -- Bayesian Networks}
...
\end{itemize}
\plainidea{Block 2 starts a new question: what should an agent believe when the world is uncertain and the evidence is incomplete?}
\end{frame}
